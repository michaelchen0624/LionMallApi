...
{
    public class IncreExpression: ExpressionVisitor
    {
        #region sql指令
        ...
        /// <returns></returns>
        public IncreExpression(LambdaExpression expression, ProviderOption providerOption)
        {
        ...
        private void SetParam(string fieldName, string paramName, object value)
        {
            ...
            _sqlCmd.AppendFormat(" {0}={0}+{1} ", fieldName, n);
            Param.Add(n, value);
        }
    }
}
